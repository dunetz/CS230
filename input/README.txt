DataLoader.py contains DataLoader class for reading zip files into pandas dataframes
...
GenerateBatch.py contains GenerateBatch class for creating batches of sequence data (i.e. sliding windows) into LSTM model.
